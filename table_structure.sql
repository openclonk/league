...
--
-- Dumping data for table `lg_admin_permissions`
--

LOCK TABLES `lg_admin_permissions` WRITE;
/*!40000 ALTER TABLE `lg_admin_permissions` DISABLE KEYS */;
INSERT INTO `lg_admin_permissions` VALUES
(1,'clan',''),
(1,'cuid_ban',''),
(1,'debug',''),
(1,'game',''),
...
(34,'test',''),
(34,'user','');
/*!40000 ALTER TABLE `lg_admin_permissions` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `lg_cuid_bans` (
  `cuid` varchar(8) NOT NULL DEFAULT '',
...
CREATE TABLE `lg_game_reference` (
  ...
  PRIMARY KEY (`game_id`)
) ENGINE=InnoDB AUTO_INCREMENT=87561 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lg_games` (
  ...
  KEY `csid` (`csid`)
) ENGINE=InnoDB AUTO_INCREMENT=87561 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(2,11,12,'melee',1356994800,1577836800,'images/icons/type_melee_16.png','','N','N',0,1,'images/icons/type_melee.png','images/icons/type_melee_off.png',0,5,1577589941,'N',20,100,31),
(3,32,33,'settle',1356994800,1577836800,'images/icons/type_adventure_16.png','','N','Y',0,1,'images/icons/type_adventure.png','images/icons/type_adventure_off.png',0,0,0,'Y',0,0,31),
(4,77,78,'settle',1412373600,1601762400,'images/icons/type_worlds_16.png','','N','Y',0,1,'images/icons/type_worlds.png','images/icons/type_worlds_off.png',0,0,0,'N',0,0,31),
(5,234,235,'settle',1484671307,4102444800,'images/icons/type_defense_16.png','','N','Y',0,1,'images/icons/type_defense.png','images/icons/type_defense_off.png',0,0,0,'Y',0,0,31),
(6,307,308,'settle',1520159629,2524604400,'images/icons/type_tower_of_despair_16.png','','N','Y',0,1,'images/icons/type_tower_of_despair.png','images/icons/type_tower_of_despair_off.png',0,0,0,'Y',0,0,31);
...
CREATE TABLE `lg_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=23654056 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(1,'OpenClonk','images/icons/oc_icon_16.png','5.0.0','oc',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=936 DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lg_users` (
  ...
  `real_name` varchar(45) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '',
  `date_created` int(10) unsigned NOT NULL DEFAULT 0,
...
-- Dump completed on 2025-01-11 20:35:36
